            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Pro Subscribers</dt>
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">3,842</div>
                      </dd>
                    </dl>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">76,249</div>
                      </dd>
                    </dl>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">$48,352</div>
                      </dd>
                    </dl>
                  </div>
                </div>
          ...
          <div className="bg-white shadow rounded-lg mb-6">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                These tools are only available to administrators with Pro plan access.
              </p>
            </div>
            <div className="p-6">
